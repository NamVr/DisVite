    ...
    async connectToDatabase(mongoURI, attempt = 1) {
        try {
            ...
            if (attempt < 3) {
                ...
                console.error("Discord Invite Tracker: Failed to connect to MongoDB after 3 attempts");
                throw new Error("Discord Invite Tracker: MongoDB connection impossible.");
            }
        }
    }
    initialize() {
