...
export class GuildTaskQueue {
	 ...
	 */
	public async enqueue<T>(guildId: string, task: () => Promise<T>): Promise<T> {
	 ...
	 */
	public get activeGuilds(): number {
	 ...
	 */
	public getQueueDepth(guildId: string): number {
